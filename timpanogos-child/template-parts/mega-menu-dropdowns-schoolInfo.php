<div class="dropDownColumn">
	...
	?>
		<ul>
			...
			<li class="int"><a href="https://timpanogos.provo.edu/school-information/district-school-year-calendar/">District Events Calendar</a></li>
		</ul>
	<?php 
		//checks if this template section is loading into the menu or into the sidebar/content area and assigns the proper heading
		if(is_page( 'school-information' ) || in_array( 117, get_post_ancestors($post))){
...
<div class="dropDownColumn">
	<?php 
		...
		if(is_page( 'school-information' ) || in_array( 117, get_post_ancestors($post))){
			?>
			<h2><img src="https://timpanogos.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/school-info.svg" alt="" />About Timpanogos</h2>
			<?php	
		} else {
			?>
